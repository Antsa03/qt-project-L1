/********************************************************************************
** Form generated from reading UI file 'SortieProduit.ui'
**
...
#ifndef UI_SORTIEPRODUIT_H
#define UI_SORTIEPRODUIT_H
...
public:
    ...
    QLabel *label_4;
    QLineEdit *leNumBonSortie;
    QWidget *horizontalWidget_4;
    QHBoxLayout *horizontalLayout_6;
    QLabel *label_6;
    QLineEdit *leQteSortie;
    QWidget *horizontalWidget_5;
    QHBoxLayout *horizontalLayout_5;
    QLabel *label_5;
    QDateEdit *deDateSortie;
    ...
    void setupUi(QMainWindow *SortieProduitClass)
    {
        if (SortieProduitClass->objectName().isEmpty())
            SortieProduitClass->setObjectName("SortieProduitClass");
        SortieProduitClass->resize(1205, 656);
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/MiseAJour/img/exporter.png"), QSize(), QIcon::Normal, QIcon::Off);
        SortieProduitClass->setWindowIcon(icon);
        centralWidget = new QWidget(SortieProduitClass);
...
"padding-left: 7px;"));
        ...
        leNumBonSortie = new QLineEdit(horizontalWidget_3);
        leNumBonSortie->setObjectName("leNumBonSortie");
        leNumBonSortie->setMinimumSize(QSize(500, 40));
        leNumBonSortie->setMaximumSize(QSize(166564, 40));
        leNumBonSortie->setFont(font3);
        leNumBonSortie->setStyleSheet(QString::fromUtf8("background-color: #ffffff;\n"
"border-radius: 5px;\n"
"padding-left: 7px;"));

        horizontalLayout_4->addWidget(leNumBonSortie);
        ...
        leQteSortie = new QLineEdit(horizontalWidget_4);
        leQteSortie->setObjectName("leQteSortie");
        leQteSortie->setMinimumSize(QSize(500, 40));
        leQteSortie->setMaximumSize(QSize(1622666, 40));
        leQteSortie->setFont(font3);
        leQteSortie->setStyleSheet(QString::fromUtf8("background-color: #ffffff;\n"
"border-radius: 5px;\n"
"padding-left: 7px;"));

        horizontalLayout_6->addWidget(leQteSortie);
        ...
        deDateSortie = new QDateEdit(horizontalWidget_5);
        deDateSortie->setObjectName("deDateSortie");
        deDateSortie->setMinimumSize(QSize(0, 40));
        deDateSortie->setMaximumSize(QSize(16777215, 40));
        deDateSortie->setStyleSheet(QString::fromUtf8("background-color: #ffffff;\n"
"border-radius: 5px;\n"
"font: 16pt \"Segoe UI\";"));
        deDateSortie->setAlignment(Qt::AlignCenter);

        horizontalLayout_5->addWidget(deDateSortie);
        ...
        verticalWidget1->setMinimumSize(QSize(340, 0));
...
"padding-left: 7px;"));
        ...
        verticalWidget_21->setMinimumSize(QSize(340, 0));
        ...
        verticalWidget2->setMinimumSize(QSize(340, 0));
...
"padding-left: 7px;"));
        ...
        verticalWidget_22->setMinimumSize(QSize(340, 0));
        ...
        verticalWidget3->setMinimumSize(QSize(340, 0));
...
"padding-left: 7px;"));
        ...
        verticalWidget_23->setMinimumSize(QSize(340, 0));
        ...
        horizontalLayout_7->setSpacing(25);
...
""));
        ...
        SortieProduitClass->setCentralWidget(centralWidget);

        retranslateUi(SortieProduitClass);

        QMetaObject::connectSlotsByName(SortieProduitClass);
    } // setupUi

    void retranslateUi(QMainWindow *SortieProduitClass)
    {
        SortieProduitClass->setWindowTitle(QCoreApplication::translate("SortieProduitClass", "Sortie produit", nullptr));
        btnRetour->setText(QString());
        label->setText(QCoreApplication::translate("SortieProduitClass", "MISE A JOUR DU STOCK DE PRODUIT", nullptr));
        label_2->setText(QCoreApplication::translate("SortieProduitClass", "SORTIE DE PRODUIT", nullptr));
        label_3->setText(QCoreApplication::translate("SortieProduitClass", "Num\303\251ro de produit", nullptr));
        label_4->setText(QCoreApplication::translate("SortieProduitClass", "Num\303\251ro de Bon de Sortie", nullptr));
        label_6->setText(QCoreApplication::translate("SortieProduitClass", "Quantit\303\251 de sortie", nullptr));
        label_5->setText(QCoreApplication::translate("SortieProduitClass", "Date de sortie", nullptr));
        label_7->setText(QCoreApplication::translate("SortieProduitClass", "Designation", nullptr));
        lbDesign->setText(QString());
        label_8->setText(QCoreApplication::translate("SortieProduitClass", "Stock initial", nullptr));
        lbStockInitial->setText(QString());
        label_10->setText(QCoreApplication::translate("SortieProduitClass", "Stock final", nullptr));
        lbStockFinal->setText(QString());
        btnMaJ->setText(QCoreApplication::translate("SortieProduitClass", "Mise \303\240 jour", nullptr));
        btnSuivant->setText(QCoreApplication::translate("SortieProduitClass", "Suivant", nullptr));
    } // retranslateUi

};

namespace Ui {
    class SortieProduitClass: public Ui_SortieProduitClass {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_SORTIEPRODUIT_H
